<!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#seller-edit-modal">Open modal for @mdo</button> -->

<div class="modal fade" id="seller-edit-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" data-js="seller-edit-form" action="/">
          @csrf
          @method('PUT')
          <div class="mb-3">
